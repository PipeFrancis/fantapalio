...
//Extra da eliminare (inizio)
    // SEMI
MassimilianoMoretti.semi = 4.2;
AndreaMoretti.semi = 7.5;
LarryTrevisan.semi = 1.3;
AlessandroCostantini.semi = 6.8;
MatteoMargarit.semi = 3.1;
MauroCuridori.semi = 2.6;
ChristianZanet.semi = 5.9;
GiacomoPiacentini.semi = 0.5;
GiovanniDalFarra.semi = 9.7;
MiracleObichukwu.semi = 6.4;
LucaDellaLonga.semi = 3.7;
AlessandroRojatti.semi = 8.2;
MicheleGorasso.semi = 7.1;
GiacomoFerigo.semi = 2.9;
UmbertoNobile.semi = 1.4;
DevinChiarcos.semi = 9.5;
ValentinoCigainero.semi = 6.1;
MicheleDeAnna.semi = 4.3;
DavideParon.semi = 0.9;
AlessioFurlan.semi = 2.4;
MichaelMargarit.semi = 7.8;
SebastianoTonizzo.semi = 3.3;

DanieleGanzit.semi = 5.2;
GiacomoSilvestri.semi = 4.7;
VittorioGri.semi = 8.6;
VittorioBasso.semi = 1.5;
AlessandroRizzi.semi = 9.3;
MassimoBaldassi.semi = 6.0;
GabrieleMiani.semi = 7.7;
MarcoMarchetti.semi = 5.4;
MarcoLombardo.semi = 8.1;
MicheleVendrame.semi = 2.8;
LorenzoSchinella.semi = 4.5;
GioeleTudini.semi = 9.0;
FilippoPasquon.semi = 3.6;
TommasoMartello.semi = 1.2;
MarcoRizzi.semi = 7.9;
DavidGaspardo.semi = 6.3;
AntonioGri.semi = 0.7;
RiccardoSchinella.semi = 8.4;

SimoneMartinelli.semi = 5.6;
MatteoSpagnolo.semi = 7.3;
DavideFaurlin.semi = 2.1;
GiovanniTonizzo.semi = 3.4;
AlessandroSant.semi = 9.8;
MatteoBazzaro.semi = 4.1;
AlessandroSantin.semi = 7.2;
AlessandroGalassi.semi = 1.8;
PietroSoramel.semi = 6.5;
FilippoAgnoluzzi.semi = 0.3;
EmanueleDaneluzzi.semi = 2.7;
LucaSoramel.semi = 4.9;
PaoloZorzi.semi = 9.1;
ChristianFedrizzi.semi = 5.0;
FilippoSappa.semi = 3.0;
GiovanniZanin.semi = 1.9;
EnricoSant.semi = 6.6;
StefanoPolano.semi = 2.0;

MarcoPolo.semi = 8.9;
MarcoSerrao.semi = 0.6;
WilliamIob.semi = 3.8;
DavideBroggi.semi = 9.4;
AlexMicottis.semi = 5.5;
MassimilianoRossi.semi = 4.8;
MassimoMasotti.semi = 7.4;
EugenioDeTina.semi = 1.7;
LucaAnedda.semi = 6.9;
DenisVanin.semi = 0.2;
ThomasBaracetti.semi = 2.5;
LucaGemo.semi = 7.6;
DiegoNata.semi = 4.4;
MattiaRoiatti.semi = 3.2;
EdoardoPicogna.semi = 8.3;
MauroPerina.semi = 1.1;
LorenzoMoro.semi = 5.3;
GionaTell.semi = 0.4;
IacopoPivetta.semi = 8.5;
MattiaMasotti.semi = 2.2;

// Tiro da 3
MassimilianoMoretti.td3 = 5.2;
AndreaMoretti.td3 = 6.1;
LarryTrevisan.td3 = 1.9;
AlessandroCostantini.td3 = 4.6;
MatteoMargarit.td3 = 2.3;
MauroCuridori.td3 = 8.7;
ChristianZanet.td3 = 3.5;
GiacomoPiacentini.td3 = 7.6;
GiovanniDalFarra.td3 = 0.5;
MiracleObichukwu.td3 = 6.3;
LucaDellaLonga.td3 = 4.8;
AlessandroRojatti.td3 = 2.1;
MicheleGorasso.td3 = 9.2;
GiacomoFerigo.td3 = 5.4;
UmbertoNobile.td3 = 1.7;
DevinChiarcos.td3 = 0.8;
ValentinoCigainero.td3 = 3.6;
MicheleDeAnna.td3 = 9.9;
DavideParon.td3 = 2.5;
AlessioFurlan.td3 = 8.4;
MichaelMargarit.td3 = 0.4;
SebastianoTonizzo.td3 = 4.7;

DanieleGanzit.td3 = 6.2;
GiacomoSilvestri.td3 = 1.3;
VittorioGri.td3 = 7.8;
VittorioBasso.td3 = 3.9;
AlessandroRizzi.td3 = 5.0;
MassimoBaldassi.td3 = 0.1;
GabrieleMiani.td3 = 9.4;
MarcoMarchetti.td3 = 2.6;
MarcoLombardo.td3 = 7.1;
MicheleVendrame.td3 = 3.2;
LorenzoSchinella.td3 = 4.9;
GioeleTudini.td3 = 0.3;
FilippoPasquon.td3 = 8.5;
TommasoMartello.td3 = 1.8;
MarcoRizzi.td3 = 6.0;
DavidGaspardo.td3 = 2.7;
AntonioGri.td3 = 5.5;
RiccardoSchinella.td3 = 0.6;

SimoneMartinelli.td3 = 3.7;
MatteoSpagnolo.td3 = 9.0;
DavideFaurlin.td3 = 1.2;
GiovanniTonizzo.td3 = 8.1;
AlessandroSant.td3 = 4.3;
MatteoBazzaro.td3 = 5.6;
AlessandroSantin.td3 = 2.9;
AlessandroGalassi.td3 = 3.4;
PietroSoramel.td3 = 7.7;
FilippoAgnoluzzi.td3 = 0.8;
EmanueleDaneluzzi.td3 = 9.6;
LucaSoramel.td3 = 6.5;
PaoloZorzi.td3 = 1.0;
ChristianFedrizzi.td3 = 4.2;
FilippoSappa.td3 = 3.1;
GiovanniZanin.td3 = 0.4;
EnricoSant.td3 = 5.3;
...
MarcoSerrao.td3 = 2.0;
WilliamIob.td3 = 3.0;
DavideBroggi.td3 = 5.1;
AlexMicottis.td3 = 1.6;
MassimilianoRossi.td3 = 0.7;
MassimoMasotti.td3 = 8.2;
EugenioDeTina.td3 = 4.1;
LucaAnedda.td3 = 6.4;
DenisVanin.td3 = 7.9;
ThomasBaracetti.td3 = 9.7;
LucaGemo.td3 = 0.9;
DiegoNata.td3 = 5.8;
MattiaRoiatti.td3 = 1.5;
EdoardoPicogna.td3 = 2.4;
MauroPerina.td3 = 7.2;
LorenzoMoro.td3 = 3.3;
GionaTell.td3 = 6.7;
IacopoPivetta.td3 = 4.4;
MattiaMasotti.td3 = 0.2;

// FINALE
MassimilianoMoretti.final = 2.3;
AndreaMoretti.final = 5.4;
LarryTrevisan.final = 6.9;
AlessandroCostantini.final = 0.1;
MatteoMargarit.final = 7.8;
MauroCuridori.final = 1.2;
ChristianZanet.final = 4.5;
GiacomoPiacentini.final = 9.9;
GiovanniDalFarra.final = 3.6;
MiracleObichukwu.final = 0.7;
LucaDellaLonga.final = 8.3;
AlessandroRojatti.final = 4.2;
MicheleGorasso.final = 3.1;
GiacomoFerigo.final = 7.6;
UmbertoNobile.final = 2.9;
DevinChiarcos.final = 5.7;
...
DanieleGanzit.final = 5;
GiacomoSilvestri.final = 8.7;
VittorioGri.final = 9.2;
VittorioBasso.final = 2.8;
AlessandroRizzi.final = 1.1;
MassimoBaldassi.final = 4.9;
GabrieleMiani.final = 0.3;
MarcoMarchetti.final = 7.0;
MarcoLombardo.final = 3.2;
MicheleVendrame.final = 4.6;
LorenzoSchinella.final = 0.5;
GioeleTudini.final = 7.3;
FilippoPasquon.final = 6.1;
TommasoMartello.final = 2.7;
MarcoRizzi.final = 3.9;
DavidGaspardo.final = 8.5;
AntonioGri.final = 1.4;
RiccardoSchinella.final = 9.8;

SimoneMartinelli.final = 0.9;
MatteoSpagnolo.final = 6.7;
DavideFaurlin.final = 4.4;
GiovanniTonizzo.final = 2.5;
AlessandroSant.final = 3.4;
MatteoBazzaro.final = 7.2;
AlessandroSantin.final = 5.8;
AlessandroGalassi.final = 8.1;
PietroSoramel.final = 4.0;
FilippoAgnoluzzi.final = 9.4;
EmanueleDaneluzzi.final = 1.0;
LucaSoramel.final = 5.1;
PaoloZorzi.final = 6.5;
ChristianFedrizzi.final = 2.2;
FilippoSappa.final = 7.5;
GiovanniZanin.final = 0.8;
EnricoSant.final = 3.7;
StefanoPolano.final = 0.6;

MarcoPolo.final = 4.3;
MarcoSerrao.final = 1.6;
WilliamIob.final = 9.7;
DavideBroggi.final = 0.2;
AlexMicottis.final = 6.4;
MassimilianoRossi.final = 8.6;
MassimoMasotti.final = 3.3;
EugenioDeTina.final = 2.0;
LucaAnedda.final = 9.5;
DenisVanin.final = 4.9;
ThomasBaracetti.final = 7.8;
LucaGemo.final = 5.7;
DiegoNata.final = 0.3;
MattiaRoiatti.final = 8.8;
EdoardoPicogna.final = 2.9;
MauroPerina.final = 6.6;
LorenzoMoro.final = 7.1;
GionaTell.final = 0.1;
IacopoPivetta.final = 9.0;
MattiaMasotti.final = 1.3;
