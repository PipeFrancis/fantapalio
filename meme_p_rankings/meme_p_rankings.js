...
document.addEventListener('DOMContentLoaded', function() {
    ...
    sortedPlayers.forEach((player, index) => {
        ...
        //     <p>G1: ${player.stats_g1[MEME]*pdkWeights[18]}</p>
        //     <p>G2: ${player.stats_g2[MEME]*pdkWeights[18]}</p>
        //     <p>G3: ${player.stats_g3[MEME]*pdkWeights[18]}</p>
        //     <p>Semifinale: ${player.stats_semi[MEME]*pdkWeights[18]}</p>
        //     <p>Tiro da 3: ${player.stats_td3[11]*td3Weights[11]+player.stats_td3[12]*td3Weights[12]}</p>
        //     <p>Finale: ${player.stats_final[MEME]*pdkWeights[18]}</p>
        ...
        if (what_day_is_it >= 1) {
            cardHtml += `<p>G1: ${(player.stats_g1[MEME] * pdkWeights[18])}</p>`;
        }
        if (what_day_is_it >= 2) {
            cardHtml += `<p>G2: ${(player.stats_g2[MEME] * pdkWeights[18])}</p>`;
        }
        if (what_day_is_it >= 3) {
            cardHtml += `<p>G3: ${(player.stats_g3[MEME] * pdkWeights[18])}</p>`;
        }
        if (what_day_is_it >= 4) {
            cardHtml += `<p>Semifinale: ${(player.stats_semi[MEME] * pdkWeights[18])}</p>`;
        }
        if (what_day_is_it >= 5) {
        ...
        if (what_day_is_it >= 6) {
            cardHtml += `<p>Finale: ${(player.stats_final[MEME] * pdkWeights[18])}</p>`;
        }
