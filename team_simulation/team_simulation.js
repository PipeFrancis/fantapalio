...
import { players, player_history_array } from '../data260721_2225.js';
...
// Funzione per aggiornare i crediti rimanenti o mostrare il messaggio VALIDO + Totale
function updateCreditsCounter() {
    ...
    if (selectedPlayers.length === 5) {
        ...
        creditsCounter.innerHTML = `✅ <b><span class="green_text">VALIDA</span></b> - Totale: <b>$${totalCost}/30</b><br>Continua sotto`;
    } else {
...
function populatePlayersList() {
    ...
    // playersContainer.parentNode.insertBefore(creditsCounter, playersContainer.nextSibling); // changed after fp26
    // To show credits ABOVE the player list:
    playersContainer.parentNode.insertBefore(creditsCounter, playersContainer);
}
